      ...
      <div className="experience-container">
        ...
        <div className="experience-grid">
          <div className="experience-node">
            ...
            <p>
              Developing a full-stack web application that functions as a
              library for clients to search and view the data for their military
              project.
            </p>
            <p>
              Utilizing a react framework, typescript, SQL, and node.js stack.
            </p>
            <p className="text-xs">
              Skills: Typescript, Gitlab, Node.JS, Next.JS, Docker, SQL,
          ...
          <div className="experience-node">
            ...
            <p>
              Resolves computer hardware and software issues. Re-images
              computers and devices. Troubleshoots fax machines and printers.
            </p>
            <p className="text-xs">
