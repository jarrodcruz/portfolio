  ...
  return (
    <div className="experience-container ">
      ...
      <div className="experience-node">
        ...
        <p>Utilizing a react framework, typescript, SQL, and node.js stack.</p>
        <p className="text-xs">
      ...
      <div className="experience-node">
        ...
        <p>
          Resolves computer hardware and software issues. Re-images computers and devices. 
          Troubleshoots fax machines and printers.
        </p>
        <p className="text-xs">
